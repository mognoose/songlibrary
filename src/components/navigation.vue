...
export default {
  ...
  data() {
    return {
      authUrl: "https://be.contentful.com/oauth/authorize?response_type=token&client_id="+process.env.VUE_APP_CTF_CLIENT_ID+"&redirect_uri=https://songlibrary.herokuapp.com&scope=content_management_manage",
      menuOpen: "",
    };
  },
  methods: {
